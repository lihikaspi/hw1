...
def main(argv):
    ...
    statistics.population_statistics("Winter Holiday records:", holiday[1], "t1", "cnt", 13.0, 0, func)
    statistics.population_statistics("Winter Weekday records:", holiday[0], "t1", "cnt", 13.0, 0, func)
    print("If t1>13.0, then:")
    statistics.population_statistics("Winter Holiday records:", holiday[1], "t1", "cnt", 13.0, 1, func)
    statistics.population_statistics("Winter Weekday records:", holiday[0], "t1", "cnt", 13.0, 1, func)
    # double code --> fix
